...
//		boolean active = scanner.nextBoolean();
	...
	public static void displayProductDetails(ArrayList<Product> productList) {
		...
		System.out.println("SL NO" + "    " + "Product Code" + "    " + "Product Name" + "    " + "Product Description"
				+ "    " + "Product Price" +"	"+ "Open Date" + "    "+ "Validity Date" + "    " + "Expiry Date" + "    " + "Active");
		...
		for (Product product : productList) {
			System.out.println("    " + product.getSerialNoOriginal() + "    " + product.getProductCode() + "    "
					...
					+ product.getProductPrice() + "    " + dateFormat.format(product.getOpenDate()) + "    "  + dateFormat.format(product.getValidityDate()) + "    "  + dateFormat.format(product.getExpiryDate()) + "    " + product.isActive());
